            ...
            {members.map(member => {
              ...
              return (
                <TableRow key={member._id}>
                  ...
                  <TableCell padding="none">{isCommander && <Grade />}</TableCell>
                  <TableCell padding="none">{isSquadMember && <DriveEta />}</TableCell>
                  <TableCell padding="none">{hasVotedForSquad && <ThumbsUpDown />}</TableCell>
                  <TableCell padding="none">{hasVotedForQuest && <ThumbsUpDown />}</TableCell>
                </TableRow>
              );
            })}
          </TableBody>
...
export default withStyles(styles)(
  connect(mapStateToProps, null)(MembersTable)
);
